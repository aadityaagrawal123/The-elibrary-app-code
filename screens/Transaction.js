...
const URL = 'https://console.firebase.google.com/u/0/project/e-library-app-db/firestore/data/~2Fbooks';
...
export default class TransactionScreen extends Component {
  ...
  handleTransaction = async () => {
    ...
    if (!transactionType) {
      ...
      var isEligible1 = await this.checkStudentEligibilityForBookReturn(
        bookId,
        studentId
      );
...
checkStudentEligibilityForBookIssue = async studentId => {
     ...
     Alert.alert("The student id doesn't exist in the database!");
      ...
      studentRef.docs.map(doc => {
        if (doc.data().number_of_books_issued < 2) {
          ...
          isStudentEligible = false;
          Alert.alert("The student has already issued 2 books, cannot issue more than 2 books !");
          this.setState({
            bookId: "",
            studentId: ""
          });
  ...
  openDb = () =>{
     Linking.openURL(URL).catch((err) => Alert.alert('An error occurred'));
  }
  ...
  render() {
    ...
    return (
      ...
      <SafeAreaView style={styles.droidSafeArea} /> 
        ...
        <TouchableOpacity style={styles.db} onPress ={this.openDb} > 
        <Text style={styles.dbText}> Database </Text> 
        </TouchableOpacity>
